...
namespace CommonUtils.Objects
{
    ...
    public class LocalizableString : IComparable, ICloneable, IConvertible, IComparable<string>, IEnumerable<char>, IEnumerable, IEquatable<string>
    {
        ...
        {
            return GetString(OriginalString, false, languageCode);
        }
        ...
        /// <returns></returns>
        public string ToString(string languageCode, bool getFirstValueIfNotExists = false)
        {
            string res;
        ...
        //public static explicit operator DateTime(LocalizableString date)
        //{
        ...
        public List<String> Languages
        {
            get
            {
                if (_languages == null)
                {
                    ...
                    {
                        _languages = new List<String> {String.Empty};
                    }
                }
