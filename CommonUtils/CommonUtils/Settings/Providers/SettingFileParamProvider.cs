...
{
    //public class SettingFileParamProvider<T> : BaseParamProvider<T> where T : BaseSettings
    //{
    //    public SettingFileParamProvider(string moduleName, T settingClass) : base(moduleName, settingClass)
    //    {
    ...
    //    {
    //        return base.GetParamInfo(paramName);
    //    }
